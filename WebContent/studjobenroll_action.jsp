...
<%
    ...
    //ResultSet rs;
    int i = st.executeUpdate("insert into job_enrollment(id,fname,lname,mob,email,branch,year,job,company) values ('" + id + "','" + fname + "','" + lname + "','" + mob + "','" + email + "','" + branch + "','" + year + "','" + job + "','" + company + "')");
    if (i > 0) {
        //session.setAttribute("uname", uname);
        out.println(" <h1><b>You are Successfully Register for Job ! <a href='index.jsp'>Go Back</h1></b></a>");
