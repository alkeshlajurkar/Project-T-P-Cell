...
<html>
<title>TRPCELL/Registrationdetails</title>
<meta charset="UTF-8">
...
<nav class="wd-sidebar wd-bar-block wd-small wd-hide-small wd-center">
  ...
  <a href="#registrationdetails" class="wd-bar-item wd-button wd-padding-large wd-white">
...
<div class="wd-top wd-hide-large wd-hide-medium" id="myNavbar">
  <div class="wd-bar wd-black wd-opacity wd-hover-opacity-off wd-center wd-small">
    ...
    <a href="#registrationdetails" class="wd-bar-item wd-button" style="width:25% !important">REGISTRATION DETAILS</a>
	<a href="#trainingenrollment" class="wd-bar-item wd-button" style="width:25% !important">TRAINING ENROLLMENT</a>
	<a href="#jobdetails" class="wd-bar-item wd-button" style="width:25% !important">JOB APPLICATION</a>
	...
	<a href="#admindetails" class="wd-bar-item wd-button" style="width:25% !important">ADMIN</a>
  </div>
</div>
...
<div class="wd-padding-large" id="main">
  ...
  <!-- Header/Logindetails -->
    <h2 id="registrationdetails">Registration Details</h2>
...
String sql;
if(query!=null){
	sql="select * from registration where fname like '%"+query+"%' or lname like '%"+query+"%' or uname like '%"+query+"%' or password like '%"+query+"%'" ;
	}else{
