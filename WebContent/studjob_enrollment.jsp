...
<!-- Request  Section -->
  <div class="wd-padding-64 wd-content wd-text-grey">
    <h2 class="wd-text-light-grey">Job Enrollment</h2>
    <hr style="width:200px" class="wd-opacity">

    <p>Fill Out the Form to Apply for Job:</p>

    <form action="studjobenroll_action.jsp" target="_blank" autocomplete="off">
    <p>Student ID:</p>
      <p><input class="wd-input wd-padding-16" type="int" placeholder="Student ID" required name="id"></p>
       <p>First Name:</p>
       <p><input class="wd-input wd-padding-16" type="text" placeholder="First Name" required name="fname"></p>
        ...
        <p>Mobile No.:</p>
         <p><input class="wd-input wd-padding-16" type="int" placeholder="Mobile Number" maxlength='10' required name="mob"></p>
      <p>Email:</p>
      <p><input class="wd-input wd-padding-16" type="text" placeholder="Email" required name="email"></p>
      <p>Select Branch: </p>
      <p><select name="branch" class="wd-input wd-padding-16"required>
    <option>CSE</option>
	<option>IT</option>
	<option>ENTC</option>
	<option>ME</option>
	...
	<p>Select Year:</p>
	<p><select name="year" class="wd-input wd-padding-16"required>
	...
	<p>Select Job Name:</p>
	<p><select name="job" class="wd-input wd-padding-16"required>
	...
	<p><select name="company" class="wd-input wd-padding-16"required>
    <option>TCS</option>
	<option>INFOSYS</option>
	<option>ACCENTURE</option>
	<option>AMAZON</option>
	<option>CAPGEMINIE</option>
	</select></p>
     <p>
