...
<html>
<title>TRPCELL/Trainingdetails</title>
<meta charset="UTF-8">
...
<nav class="wd-sidebar wd-bar-block wd-small wd-hide-small wd-center">
  ...
  <a href="#trainingenrollment" class="wd-bar-item wd-button wd-padding-large wd-white">
  ...
  <a href="contactdetails.jjsp" class="wd-bar-item wd-button wd-padding-large wd-white">
...
<div class="wd-top wd-hide-large wd-hide-medium" id="myNavbar">
  <div class="wd-bar wd-black wd-opacity wd-hover-opacity-off wd-center wd-small">
	...
	<a href="#" class="wd-bar-item wd-button" style="width:25% !important">TRAINING ENROLLMENT</a>
...
<div class="wd-padding-large" id="main">
  ...
  <!-- Header/Logindetails -->
  <h2 id="trainingenrollment">Training Enrollment</h2>
...
String sql;
if(query!=null){
	sql="select * from training_enrollment where fname like '%"+query+"%' or lname like '%"+query+"%' or mob like '%"+query+"%' or email like '%"+query+"%' or branch like '%"+query+"%' or year like '%"+query+"%' or training like '%"+query+"%'" ;
	}else{
		sql ="select * from training_enrollment order by id desc";
	}
...
<td><%=resultSet.getString("training") %></td>
